  ...
  const ServiceModal = ({ service }: { service: string }) => {
    const serviceContent = {
      'Data Annotation Services': {
        ...
        content: 'Our experienced team of annotators, with 4-5 years of expertise, provides fast and high-quality data labeling services either at your office or remotely for computer vision model training. You can entrust this work to us and be confident in receiving quality results.',
        formPrompt: 'Leave your project details, guest access parameters, and receive sample data the next day'
      },
      'Quality Assurance': {
        title: 'Quality Assurance Services',
        content: 'Are you expecting high-quality data annotation from your team? We will review the results to increase data reliability. Leave your project details and access information, and your data will always meet your expectations.',
        formPrompt: 'Share your project requirements for enhanced data quality'
      },
      'Technical Staff Replacement': {
        title: 'Technical Staff Replacement',
        content: 'We provide temporary staff coverage during vacations or sick leave to ensure your office maintains continuous technical support. We\'re ready to help you under any circumstances with comprehensive personnel replacement services, keeping your operations running smoothly.',
        formPrompt: 'Tell us about your staffing needs'
      },
      'Documentation Support': {
        title: 'Documentation Support',
        content: 'We develop custom document templates, spreadsheets, and reports based on your existing documents and requirements. Our team ensures your documentation is well-structured, professional, and meets all your specific needs.',
        formPrompt: 'Describe your documentation requirements'
      },
      'Rapid Website Development': {
        title: 'Rapid Website Development',
        content: 'We quickly create modern landing pages according to client requirements, assist with hosting, domain registration, updates, and deployment. We ensure website backup and ongoing support. Our comprehensive services include SEO optimization, responsive design, and integration with various platforms and tools.',
        formPrompt: 'Share your website project details'
      },
      'IT Infrastructure Support': {
        title: 'IT Infrastructure Support',
        content: 'We handle all office configurations, set up backups, implement data protection, resolve driver issues, configure remote access, and much more. We develop recommendations for equipment optimization and inventory management. Our team is committed to quickly resolving any technical problems you encounter.',
        formPrompt: 'Describe your IT infrastructure needs'
      },
      'On-site Technical Support': {
        title: 'On-site Technical Support',
        content: 'Your clients need setup, updates, and support for your programs and systems? Trust us with on-site service and configuration. As your trusted representative, we\'ll travel to any region to troubleshoot, install, and configure your systems.',
        formPrompt: 'Tell us about your on-site support requirements'
      },
      'Data Recovery': {
        title: 'Data Recovery Services',
        content: 'Have you lost personal photos or precious family archives? Contact us, and we\'ll make every effort to recover your data. We guarantee confidentiality and the fastest possible turnaround times.',
        formPrompt: 'Share details about your data recovery needs'
      }
    };

    const currentContent = serviceContent[service as keyof typeof serviceContent];
                ...
                <form onSubmit={handleServiceSubmit} className="space-y-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-zinc-700 border border-zinc-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-colors text-white placeholder-gray-400"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={4}
                      className="w-full px-4 py-3 bg-zinc-700 border border-zinc-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-colors text-white placeholder-gray-400 resize-none"
                ...
                >
                  {formStatus === 'sending' ? (
                    <>
                      <svg className="animate-spin h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                        <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
                        <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                      </svg>
                      <span>Sending...</span>
                    </>
                  ) : formStatus === 'success' ? (
